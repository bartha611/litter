(self["webpackChunk"] = self["webpackChunk"] || []).push([["EditProfile"],{
...
var ProfileForm = function ProfileForm(_ref) {
  ...
  }, value.length, "/", maxCharacters)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("textarea", {
...
ProfileForm.propTypes = {
  ...
  maxCharacters: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().number.isRequired),
  value: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string.isRequired),
  setValue: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func.isRequired)
};
...
/* harmony import */ var _components_Profile_CropPicture__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/Profile/CropPicture */ "./resources/js/components/Profile/CropPicture.jsx");
/* harmony import */ var _components_Profile_ProfileForm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/Profile/ProfileForm */ "./resources/js/components/Profile/ProfileForm.jsx");
/* harmony import */ var _state_ducks_auth_authThunk__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../state/ducks/auth/authThunk */ "./resources/js/state/ducks/auth/authThunk.js");
...
var EditProfile = function EditProfile(_ref) {
  ...
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(user.name),
      _useState8 = _slicedToArray(_useState7, 2),
      name = _useState8[0],
      setName = _useState8[1];

  var _useState9 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(user.biography),
  ...
  var handleSubmit = function handleSubmit() {
    ...
    dispatch((0,_state_ducks_auth_authThunk__WEBPACK_IMPORTED_MODULE_5__.fetchAuth)("/api/user/".concat(user.username), 'UPDATE', history, formData));
  };

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, _.isEmpty(crop) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
  ...
  }, "Edit Profile"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_Profile_ProfileForm__WEBPACK_IMPORTED_MODULE_4__.default, {
    title: "Name",
    maxCharacters: "50",
    value: name,
    setValue: setName
  ...
  })))), !_.isEmpty(crop) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_Profile_CropPicture__WEBPACK_IMPORTED_MODULE_3__.default, {
    settings: crop,
