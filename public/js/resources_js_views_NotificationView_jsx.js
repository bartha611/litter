(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_NotificationView_jsx"],{
...
var Notification = function Notification(_ref) {
  ...
  var getTitle = function getTitle(type, user) {
    if (type === 'App\\Notifications\\createComment') {
      return "Recent reply from ".concat(user.name);
    } else {
      return "Recent like from ".concat(user.name);
    }
  };
  ...
  }, getTitle(type, data.user))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
